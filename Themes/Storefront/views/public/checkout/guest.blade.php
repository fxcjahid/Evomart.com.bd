                            ...
                            <form @submit.prevent="placeOrder" @input="errors.clear($event.target.name)">
                                ...
                                <div class="order-product">
                                    ...
                                    <div class="item-details" v-for="cartItem in cart.items" v-cloak>
                                            ...
                                            <a class="links" target="_blank" :href="productUrl(cartItem.product)" class="product-name" v-text="cartItem.product.name"></a>
                                            <div class="summary">
                                ...
                                <div class="order-summary-details" v-cloak>
                                    <div class="-subtotal-amount">
                                        ...
                                        <span class="price-amount" v-html="cart.subTotal.inCurrentCurrency.formatted"></span>
                                    </div>
                                    <div class="-delivery-charge">
                                        <label>Delivery Charge</label>
                                        <span class="price-amount" v-html="cart.shippingCost.inCurrentCurrency.formatted"></span>
                                    </div>
                                    <div class="-total-amount">
                                        <label class="bold">{{ trans('storefront::cart.total') }}</label>
                                        <span class="price-amount bold" v-html="cart.total.inCurrentCurrency.formatted"></span>
                                    </div>
                                </div>

                                <div class="order-submit">
                                    <button type="submit" class="btn btn-primary btn-place-order" :class="{ 'btn-loading': placingOrder }" v-cloak>
                                        Complete your order
                                    </button>
                                </div>
