...
class App {
    ...
    private function setAppSettings() {
        Setting::setMany([
            ...
            'store_email'               => 'admin@evomart.test',
            ...
            'translatable'              => [
                ...
                'bkash_transfer_label'        => 'Bkash Transfer',
                'bkash_transfer_description'  => 'Make your payment with Bkash',
                'rocket_transfer_label'       => 'Rocket Transfer',
                'rocket_transfer_description' => 'Make your payment with Rocket',
            ],
