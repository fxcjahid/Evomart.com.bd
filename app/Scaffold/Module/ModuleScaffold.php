...
namespace Evomart\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use Evomart\Scaffold\Module\Generators\FilesGenerator;
use Evomart\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \Evomart\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \Evomart\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \Evomart\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \Evomart\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The Evomart {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The Evomart {$moduleName} Module.\"," . PHP_EOL;
