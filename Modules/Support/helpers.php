...
if (!function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('evomart.modules.core.config.core_modules'));
    }
}
...
if (!function_exists('evomart_version')) {
    /**
     * Get the evomart version.
     *
     * @return string
     */
    function evomart_version()
    {
        return Evomart::VERSION;
    }
}
