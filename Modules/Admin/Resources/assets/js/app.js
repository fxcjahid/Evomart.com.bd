...
$(function () {
	...
	var o = $.Evomart.options;

	// Set up the object
	_init();

	// Activate layout
	$.Evomart.layout.activate();

	// Enable sidebar tree view controls
	if (o.enableControlTreeView) {
		$.Evomart.tree('.sidebar');
	}

	// Activate sidebar push menu
	if (o.sidebarPushMenu) {
		$.Evomart.pushMenu.activate(o.sidebarToggleSelector);
	}
...
function _init() {
	...
	$.Evomart.pushMenu = {
		activate: function (toggleBtn) {
			var screenSizes = $.Evomart.options.screenSizes;
	...
	// Tree
	$.Evomart.tree = function (menu) {
		var animationSpeed = $.Evomart.options.animationSpeed;
